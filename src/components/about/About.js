        ...
        <Fade duration={1000}>
          <div className="about-text">
            ...
            <p>
              ...
              I'm a software engineer focusing on Front-End web and interested
              in people to understand them.
            </p>
            <p>
              <span role="img" aria-label="lightning">
                ⚡
              </span>{' '}
              You can find me working with HTML, CSS, Bootstrap, JavaScript,
              React, .
            </p>
